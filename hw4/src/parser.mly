...
%right ARROW
%left PLUS MINUS
%left TIMES DIVIDED REFTYPE    /* highest precedence */
...
expr:
    ...
    | LETREC; x = ID; LPAREN; y = ID; COLON; targ=texpr; RPAREN; COLON; tr=texpr; EQUALS; e1 = expr; IN; e2 = expr { Letrec(x,y,targ,tr,e1,e2) }
